#!/usr/bin/env bash
#Usage: Run from top-level of inetutils-1.9.4 and do not run as root.  Make sure to run inetutils-1.9.4.PATH_PROCNET_DEV.patch before running this (e.g., $ git apply applications/inetutils/inetutils-1.9.4-PATH_PROCNET_DEV.patch)
